<?php 
    ...
    $interval_change = "SELECT * FROM jatco_interval WHERE op = 5";
            ...
            <div class="col-md-12">
                <div class="card">    
                    <div class="card-body" >
                        ...
                        <table id="data_inspection" class="table table-hover">
                            <thead>
                                <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function(){    
            setInterval(function(){
                  $("#data_inspection").load(" #data_inspection > *");
            }, 1000);
        });
