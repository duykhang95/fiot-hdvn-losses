<?php
    ...
    $interval_change = "SELECT * FROM jatco_interval WHERE event_animation = 1";
            ...
            <div class="row align-items-center">
                <div class="col-md-6" style="margin: 20px 0px;">
                    <div class="title mb-30">
                        <h3>Thay thế định kì Jatco / Jatco インタバル交換</h3>
                    </div>
                </div>
                <div class="col-md-6" style="margin: 20px 0px;">
