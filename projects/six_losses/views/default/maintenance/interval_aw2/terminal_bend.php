<?php 
    ...
    $interval_change = "SELECT * FROM aw2_interval WHERE op = 4";
        ...
        <div class="row align-items-center">
            <div class="col-md-6" style="margin: 20px 0px;">
                <div class="title mb-30">
                    <h3> UỐN TERMINAL / ターミナル曲げ </h3>
                </div>
            </div>
            <div class="col-md-6" style="margin: 20px 0px;">
                <div class="title mb-30" style="text-align:right;">
                    <a href="index_intervalAW2">Thay thế định kì ASIN 1</a>
                </div>
            </div>
        <!-- end col -->
            <div class="col-md-12">
                <div class="card">    
                    <div class="card-body" >
                        ...
                        <table id="data_terminal" class="table table-hover">
                            <thead>
                                <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function(){    
            setInterval(function(){
                  $("#data_terminal").load(" #data_terminal > *");
            }, 1000);
        });
    </script>
