                    ...
                    <div class="card">
                        <!-- <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title"><b>BIỂU ĐỒ TỔN THẤT DỪNG DÀI</b></h3>
                            </div>
                        </div> -->
                        <div class="card-body">
...
<script type="text/javascript">
    ...
    $("#chart").load("longDt_func/chart_longDt?select_line=" + select_line + "&from_date=" + from_date + "&to_date=" + to_date);
    $("#load_table").load("longDt_func/table_longDt?select_line=" + select_line + "&from_date=" + from_date + "&to_date=" + to_date);
    ...
    function filterData(){
        ...
        const to_date = document.getElementById("to_date").value;
        // console.log(select_line);
        document.location = 'indexLongDt?select_line=' + select_line + '&from_date=' + from_date + '&to_date=' + to_date;
        // $("#chart").load("longDt_func/chart_longDt?select_line=" + select_line + "&from_date=" + from_date + "&to_date=" + to_date);
        // $("#load_table").load("longDt_func/table_longDt?select_line=" + select_line + "&from_date=" + from_date + "&to_date=" + to_date);
    }
</script>
...
<?php
    ...
    if(isset($_POST["post_delete_content"])){
        ...
        echo "<script>document.location = 'indexLongDt?select_line=".$select_line."&from_date=".$from_date."&to_date=".$to_date."</script>";
    }
