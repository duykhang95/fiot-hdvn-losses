...
//     $end_shift_3 = "$date_now 06:00:00";
    ...
    if($date_now >= "$date 06:00:00"){
        // print("TH111111");
        $output_m5 = "SELECT * FROM " . $select_line . "_output_5 WHERE time BETWEEN '$date 06:00:00' AND '$date 23:59:59' ORDER BY time ASC" ;
        ...
        for($j = 0; $j < count($data_output_m5); $j++){
            ...
            else if($data_output_m5[$j][2] >=  "$date 07:00:00" && $data_output_m5[$j][2] <= "$date 07:59:59"){
                $output_7h = $data_output_m5[$j][1];
                $performance_7h = round(($output_7h / ($target_7h + $target_6h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 08:00:00" && $data_output_m5[$j][2] <= "$date 08:59:59"){
                $output_8h = $data_output_m5[$j][1];
                $performance_8h = round(($output_8h / ($target_8h + $target_7h + $target_6h)) * 100, 2);
                
            }
            else if($data_output_m5[$j][2] >=  "$date 09:00:00" && $data_output_m5[$j][2] <= "$date 09:59:59"){
                $output_9h= $data_output_m5[$j][1];
                $performance_9h = (int)(round(($output_9h / ($target_9h + $target_8h + $target_7h + $target_6h)) * 100, 2));
            }
            else if($data_output_m5[$j][2] >=  "$date 10:00:00" && $data_output_m5[$j][2] <= "$date 10:59:59"){
                $output_10h= $data_output_m5[$j][1];
                $performance_10h = round(($output_10h / ($target_10h + $target_9h + $target_8h + $target_7h + $target_6h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 11:00:00" && $data_output_m5[$j][2] <= "$date 11:59:59"){
            ...
            else if($data_output_m5[$j][2] >=  "$date 12:00:00" && $data_output_m5[$j][2] <= "$date 12:59:59"){
            ...
            else if($data_output_m5[$j][2] >=  "$date 13:00:00" && $data_output_m5[$j][2] <= "$date 13:59:59"){
                if($data_output_m5[$j][1] == 0){
                    $output_13h = $data_output_m5[$j-1][1];
                }
            ...
            else if($data_output_m5[$j][2] >=  "$date 14:00:00" && $data_output_m5[$j][2] <= "$date 14:59:59"){
                $output_14h= $data_output_m5[$j][1];
                $performance_14h = round(($output_14h / ($target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 15:00:00" && $data_output_m5[$j][2] <= "$date 15:59:59"){
                $output_15h= $data_output_m5[$j][1];
                $performance_15h = round(($output_15h / ($target_15h + $target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 16:00:00" && $data_output_m5[$j][2] <= "$date 16:59:59"){
                $output_16h= $data_output_m5[$j][1];
                $performance_16h = round(($output_16h / ($target_16h + $target_15h + $target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 17:00:00" && $data_output_m5[$j][2] <= "$date 17:59:59"){
                $output_17h= $data_output_m5[$j][1];
                $performance_17h = round(($output_17h / ($target_17h + $target_16h + $target_15h + $target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 18:00:00" && $data_output_m5[$j][2] <= "$date 18:59:59"){
                $output_18h= $data_output_m5[$j][1];
                $performance_18h = round(($output_18h / ($target_18h + $target_17h + $target_16h + $target_15h + $target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 19:00:00" && $data_output_m5[$j][2] <= "$date 19:59:59"){
                $output_19h= $data_output_m5[$j][1];
                $performance_19h = round(($output_19h / ($target_19h + $target_18h + $target_17h + $target_16h + $target_15h + $target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 20:00:00" && $data_output_m5[$j][2] <= "$date 20:59:59"){
                $output_20h= $data_output_m5[$j][1];
                $performance_20h = round(($output_20h / ($target_20h + $target_19h + $target_18h + $target_17h + $target_16h + $target_15h + $target_14h)) * 100, 2);
            }
            else if($data_output_m5[$j][2] >=  "$date 21:00:00" && $data_output_m5[$j][2] <= "$date 21:59:59"){
                if($data_output_m5[$j][1] == 0){
                    $output_21h = $data_output_m5[$j-1][1];  
                }else{
                    $output_21h = $data_output_m5[$j][1]; 
                }
    ...
    elseif($date_now <  "$date 06:00:00" && $date_now >= "$date 00:00:00"){
        ...
        for($j = 0; $j < count($data_output_m5_shift3); $j++){
            ...
            elseif($data_output_m5_shift3[$j][2] >=  "$date 01:00:00" && $data_output_m5_shift3[$j][2] <= "$date 01:59:59"){
                $output_1h= $data_output_m5[$j][1];
                $performance_1h = round(($output_1h / ($target_1h + $target_0h + $target_23h + $target_22h)) * 100, 2);
            }
            elseif($data_output_m5_shift3[$j][2] >=  "$date 02:00:00" && $data_output_m5_shift3[$j][2] <= "$date 02:59:59"){
                $output_2h= $data_output_m5[$j][1];
            ...
            elseif($data_output_m5_shift3[$j][2] >=  "$date 05:00:00" && $data_output_m5_shift3[$j][2] <= "$date 05:59:59"){
                if($data_ouput_m5[$j][1] == 0){
                    $output_5h= $data_output_m5[$j][1];
        ...
        for($j = 0; $j < count($data_output_m5); $j++){
            ...
            elseif($data_output_m5[$j][2] >=  "$yesterday 13:00:00" && $data_output_m5[$j][2] <= "$yesterday 13:59:59"){
                if($data_output_m5[$j][1] == 0){
                    $output_13h = (int)$data_output_m5[$j-1][1];
                    $performance_13h = round(($output_13h / ($target_13h + $target_12h + $target_11h + $target_10h + $target_9h + $target_8h + $target_7h + $target_6h)) * 100, 2);
                }
            }
                    ...
                    <table id="table_1" class="table table-dark table-hover" style="text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%;" ><a style="color:white;" href="oeeHistory">Sản lượng (出来高)</a></th>
