...
<script type="text/javascript">
    ...
    $("#load_table").load("changing_func/data_changing?select_line=aw3" + "&from_date=" + from_date + "&to_date=" + to_date);

    function filterData(){
        const select_line = document.getElementById("select_line").value;
        const from_date = document.getElementById("from_date").value;
        const to_date = document.getElementById("to_date").value;
        $("#load_table").load("changing_func/data_changing?select_line=" + select_line + "&from_date=" + from_date + "&to_date=" + to_date);
    }
</script>